...
{
//  Joints q(kMapBipedEEToJoints.size(), GetJointsPerEE(), 0.0);

  Eigen::VectorXd q0 = mono::HyqlegInverseKinematics::GetJointAngles(x_B.At(E0) + Vector3d(0.0, -0.1, 0.15));
  Eigen::VectorXd q1 = mono::HyqlegInverseKinematics::GetJointAngles(x_B.At(E1) + Vector3d(0.0,  0.1, 0.15));

  return Joints({q0,q1});
//
//  q.At(E0) = mono::HyqlegInverseKinematics::GetJointAngles(x_B.At(E0) + Vector3d(0.0, -0.1, 0.15));
//  q.At(E1) = mono::HyqlegInverseKinematics::GetJointAngles(x_B.At(E1) + Vector3d(0.0,  0.1, 0.15));
//
//  return q;
}
