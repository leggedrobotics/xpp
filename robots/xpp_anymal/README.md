For ease of use, this package combines Inverse Kinematics with a anymal description provided by ANYbotics.
The original URDF description can be found here: https://github.com/ANYbotics/anymal_b_simple_description
- Alexander Winkler
