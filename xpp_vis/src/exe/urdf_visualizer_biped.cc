...
//	};
  ...
  joint_names.at(n_j*kMapIDToEE.at(L) + mono::HAA) = "L_haa_joint";
  joint_names.at(n_j*kMapIDToEE.at(L) + mono::HFE) = "L_hfe_joint";
  joint_names.at(n_j*kMapIDToEE.at(L) + mono::KFE) = "L_kfe_joint";
  joint_names.at(n_j*kMapIDToEE.at(R) + mono::HAA) = "R_haa_joint";
  joint_names.at(n_j*kMapIDToEE.at(R) + mono::HFE) = "R_hfe_joint";
  joint_names.at(n_j*kMapIDToEE.at(R) + mono::KFE) = "R_kfe_joint";
